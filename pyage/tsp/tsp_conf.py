...
from pyage.core.stats.gnuplot import TimeStatistics
...
stats = lambda: TimeStatistics('2FITNESS_%s.txt' % (("EMAS" if use_emas else "STANDARD") + "_" + str(mutation_prob) + "_MUTATION" + str(mutation_func)))
